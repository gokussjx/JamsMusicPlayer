 ...
 */
public class MusicLibraryEditorTodMultiselectAdapter extends SimpleCursorAdapter {
    private Context mContext;
    private SharedPreferences sharedPreferences;
    private Common mApp;

    public MusicLibraryEditorTodMultiselectAdapter(Context context, Cursor cursor) {
            ...
            public void onCheckedChanged(CompoundButton checkbox, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    if (checkbox.isPressed()) {
                        ...
                        AsyncGetTodSongIds task = new AsyncGetTodSongIds(songTod);
    ...
    static class AsyncGetTodSongIds extends AsyncTask<String, String, String> {
        ...
        public AsyncGetTodSongIds(String tod) {
            mTod = tod;
        }
        ...
        public void addTodToLibrary() {
            ...
            Cursor cursor = MusicLibraryEditorActivity.dbHelper.getAllSongsByTod(mTod);
