    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(R.string.done, new OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                //sharedPreferences.edit().putString("PAGE_1", adapter.getItem(0).toString().toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_1", adapter.getItem(0).toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_2", adapter.getItem(1).toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_3", adapter.getItem(2).toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_4", adapter.getItem(3).toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_5", adapter.getItem(4).toUpperCase()).apply();
                sharedPreferences.edit().putString("PAGE_6", adapter.getItem(5).toUpperCase()).apply();
