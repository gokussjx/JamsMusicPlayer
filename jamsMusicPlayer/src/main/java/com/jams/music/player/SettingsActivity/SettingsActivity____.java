...
public class SettingsActivity____ extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sharedPreferences.getBoolean("TRIAL", true)) {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                listView.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, int which, long arg3) {
                        ...
                        sharedPreferences.edit().putInt("TRACK_CHANGE_ANIMATION", which).apply();
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.startup_screen_items, currentPreference, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putInt("STARTUP_SCREEN", which).apply();
                        dialog.dismiss();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
        ...
        artistsLayoutPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.layout_preference_items, currentPreference, new OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putInt("ARTISTS_LAYOUT_PREF", which).apply();
                        dialog.dismiss();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
        ...
        albumArtistsLayoutPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.layout_preference_items, currentPreference, new OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putInt("ALBUM_ARTISTS_LAYOUT_PREF", which).apply();
                        dialog.dismiss();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
        ...
        albumsLayoutPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.layout_preference_items, currentPreference, new OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putInt("ALBUMS_LAYOUT_PREF", which).apply();
                        dialog.dismiss();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
        ...
        lockscreenControlsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.enable_disable, currentPreference, new OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        sharedPreferences.edit().putInt(Common.SHOW_LOCKSCREEN_CONTROLS, which).apply();
                        dialog.dismiss();
                ...
                builder.setSingleChoiceItems(accountNames, accountIndex, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int position) {
                        if (position != 0) {
                            ...
                            sharedPreferences.edit().putString("GOOGLE_PLAY_MUSIC_ACCOUNT", accountNames[position]).apply();
                            ...
                            sharedPreferences.edit().putBoolean("GOOGLE_PLAY_MUSIC_ENABLED", false).apply();
                            sharedPreferences.edit().putString("GOOGLE_PLAY_MUSIC_ACCOUNT", "").apply();
        ...
        rescanFoldersPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference arg0) {
                ...
                sharedPreferences.edit().putBoolean("REBUILD_LIBRARY", true).apply();
...
/*    	bluetoothControlsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.scrobbling_options, currentSelection, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
                        sharedPreferences.edit().putInt("SCROBBLING", which).apply();
            ...
            public boolean onPreferenceClick(Preference arg0) {
                ...
                builder.setSingleChoiceItems(unplugActionsArray, currentSelection, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
                        if (which == 0) {
                            sharedPreferences.edit().putString("UNPLUG_ACTION", "DO_NOTHING").apply();
                            if (sharedPreferences.getBoolean("SERVICE_RUNNING", false)) {
                                mApp.getService().unregisterReceiver(mApp.getService().getHeadsetPlugReceiver());
                            }
                        } else {
                            sharedPreferences.edit().putString("UNPLUG_ACTION", "PAUSE_MUSIC_PLAYBACK").apply();
                            if (sharedPreferences.getBoolean("SERVICE_RUNNING", false)) {
        ...
        crossfadeTracksPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                int currentSelection;
                if (sharedPreferences.getBoolean(Common.CROSSFADE_ENABLED, false)) {
                    currentSelection = 0;
                } else {
                    currentSelection = 1;
                }
                ...
                builder.setSingleChoiceItems(enableDisableArray, currentSelection, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
                        if (which == 0) {
                            sharedPreferences.edit().putBoolean(Common.CROSSFADE_ENABLED, true).apply();
                            ...
                            sharedPreferences.edit().putBoolean(Common.CROSSFADE_ENABLED, false).apply();
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                durationSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        sharedPreferences.edit().putInt(Common.CROSSFADE_DURATION, (progress + 1)).apply();
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                builder.setSingleChoiceItems(R.array.enable_disable, intCurrentSetting, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        sharedPreferences.edit().putBoolean("EQUALIZER_ENABLED", isEnabled).apply();
                        Toast.makeText(mContext, R.string.changes_saved, Toast.LENGTH_SHORT).show();
                        ...
                        if (sharedPreferences.getBoolean("SERVICE_RUNNING", false) && which == 0) {
                            mApp.getService().initAudioFX();
                        } else if (sharedPreferences.getBoolean("SERVICE_RUNNING", false) && which == 1) {
                            try {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (finalResultCode == RESULT_OK) {
                        ...
                        sharedPreferences.edit().putBoolean("GOOGLE_PLAY_MUSIC_ENABLED", true).apply();
                        sharedPreferences.edit().putString("GOOGLE_PLAY_MUSIC_ACCOUNT", mAccountName).apply();
                        return;
                    }
