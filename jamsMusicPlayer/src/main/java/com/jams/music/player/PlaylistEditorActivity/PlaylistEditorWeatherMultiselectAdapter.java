 ...
 */
public class PlaylistEditorWeatherMultiselectAdapter extends SimpleCursorAdapter {
    private Context mContext;
    private SharedPreferences sharedPreferences;
    private Common mApp;

    public PlaylistEditorWeatherMultiselectAdapter(Context context, Cursor cursor) {
            ...
            public void onCheckedChanged(CompoundButton checkbox, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    if (checkbox.isPressed()) {
                        ...
                        AsyncGetWeatherSongIds task = new AsyncGetWeatherSongIds(mContext, songWeather);
    ...
    static class AsyncGetWeatherSongIds extends AsyncTask<String, String, String> {
        ...
        public AsyncGetWeatherSongIds(Context context, String weather) {
            mApp = (Common) context.getApplicationContext();
            mWeatherName = weather;
        }
        ...
        public void addWeatherToLibrary() {
            ...
            Cursor cursor = mApp.getDBAccessHelper().getAllSongsByWeather(mWeatherName);
