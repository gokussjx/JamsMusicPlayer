 ...
 */
public class MusicLibraryEditorBpmMultiselectAdapter extends SimpleCursorAdapter {
    private Context mContext;
    private SharedPreferences sharedPreferences;
    private Common mApp;

    public MusicLibraryEditorBpmMultiselectAdapter(Context context, Cursor cursor) {
            ...
            public void onCheckedChanged(CompoundButton checkbox, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    if (checkbox.isPressed()) {
                        ...
                        AsyncGetBpmSongIds task = new AsyncGetBpmSongIds(songBpm);
    ...
    static class AsyncGetBpmSongIds extends AsyncTask<String, String, String> {
        ...
        public AsyncGetBpmSongIds(String bpm) {
            mBpm = bpm;
        }
        ...
        public void addBpmToLibrary() {
            ...
            Cursor cursor = MusicLibraryEditorActivity.dbHelper.getAllSongsByBpm(mBpm);
