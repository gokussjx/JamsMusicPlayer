    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setSingleChoiceItems(R.array.scan_frequency_choices, selectedIndex, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                    sharedPreferences.edit().putInt(SCAN_FREQUENCY, 5).apply();
                    ...
                    sharedPreferences.edit().putInt(SCAN_FREQUENCY, 1).apply();
                    ...
                    sharedPreferences.edit().putInt(SCAN_FREQUENCY, 2).apply();
                    ...
                    sharedPreferences.edit().putInt(SCAN_FREQUENCY, 3).apply();
                    ...
                    sharedPreferences.edit().putInt(SCAN_FREQUENCY, 4).apply();
